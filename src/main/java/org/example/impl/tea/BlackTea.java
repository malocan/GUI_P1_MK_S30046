...
public class BlackTea implements Tea {
  private static final TeaType TYPE = TeaType.BLACK;
  private String flavor;
  private double weight;
  private double price;

  public BlackTea(double weight) {
    this.weight = weight;
  }

  public BlackTea(String flavor, double weight) {
    this.flavor = flavor;
    this.weight = weight;
  ...
  public String toString() {
    return "black, flavor: " + flavor + ", quantity " + weight + " kg, price " + price + " PLN/kg";
  }
}
